...
public class TestProvider extends AndroidTestCase
{
  ...
  */
  public void testBasicWeatherQuery()
  {
    ...
    ContentValues testValues = TestUtilities.createTestCV_location();
    long locationRowId = db.insert(LocationEntry.TABLE_NAME, null, testValues);
    assertTrue("Error: Failure to insert North Pole Location Values", locationRowId != -1);

    // Fantastic.  Now that we have a location, add some weather!
    ContentValues weatherValues = TestUtilities.createTestCV_weather(locationRowId);
    ...
    TestUtilities.validateCursorNcontentValues("testBasicWeatherQuery", weatherCursor, weatherValues);
  }
  ...
  */
  public void testBasicLocationQueries()
  {
    ...
    // Make sure we get the correct cursor out of the database
    TestUtilities.validateCursorNcontentValues("testBasicLocationQueries, location query", locationCursor, testValues);
  ...
  public void testInsertReadProvider()
  {
    ...
    Log.d(LOG_TAG, "location url:" + locationUri.toString());
    ...
    TestUtilities.validateCursorNcontentValues("testInsertReadProvider. Error validating LocationEntry.",
            cursor, testValues);
    ...
    TestUtilities.validateCursorNcontentValues("testInsertReadProvider. Error validating WeatherEntry insert.",
    ...
    TestUtilities.validateCursorNcontentValues("testInsertReadProvider.  Error validating joined Weather and Location Data.",
            weatherCursor, weatherValues);
    ...
    TestUtilities.validateCursorNcontentValues("testInsertReadProvider.  Error validating joined Weather and Location Data with start date.",
            weatherCursor, weatherValues);
    ...
    TestUtilities.validateCursorNcontentValues("testInsertReadProvider.  Error validating joined Weather and Location data for a specific date.",
            weatherCursor, weatherValues);
  }
  ...
  */
  public void testUpdateLocation()
  {
    ...
    ContentValues values = TestUtilities.createTestCV_location();
    ...
    TestUtilities.validateCursorNcontentValues("testUpdateLocation.  Error validating location entry update.",
  ...
  public void testBulkInsert()
  {
    ...
    TestUtilities.validateCursorNcontentValues("testBulkInsert. Error validating LocationEntry.",
            cursor, testValues);
    ...
    for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, cursor.moveToNext() ) {
        TestUtilities.validateContentValues("testBulkInsert.  Error validating WeatherEntry " + i,
